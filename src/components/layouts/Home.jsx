					...
					<div className="row-nm hero-container">
								<div className="col-md-12 hero-text-container">
									<div className="hero-func-content">
										<h2> Modern botanicals for <span style={{padding: 4}}></span></h2>
									...
									<p style={{maxWidth: 500, margin: 'auto', justifyContent: 'center', textAlign: 'center', lineHeight: '1em', paddingBottom: '1em'}}>Botanicā makes science-backed, botanical medicinals to help you thrive. </p>
									<div style={{}}>
