...
class SellerDashboardProductsPage extends React.Component {
    render() {
        const { currentPage, sellerProducts } = this.props.seller
        return (
            <SellerDashboardNavWrapper>
                <TextField variant="outlined" label="Search" />
                <NButton title="Search" />
                {
                    sellerProducts.slice(
...
export default connect(mapStateToProps, { getSellerProducts, changeSellerPage })(SellerDashboardProductsPage);
