    ...
    return (
      ...
      >
        <View style={itemStyles.contentContainer}>
          {isActive}
          <Text style={(textActiveStyle, { alignSelf: 'center' })}>
  ...
  _renderPlaceholderText() {
    if (this.state.selectedItems.length == 1 && this.props.hideSelectedTags) {
      ...
      return (
        <Text
          style={[
            BrandStyles.components.placeholderText,
            { color: BrandStyles.color.black, fontWeight: 'bold' },
          ]}
        >
      ...
      return (
        <Text style={BrandStyles.components.placeholderText}> {this.props.placeholderText}</Text>
      );
    }
  }
        ...
        >
          ...
          <View style={styles.headerContentContainer}>
            ...
            <Icon
              type="FontAwesome"
              name="chevron-down"
              style={BrandStyles.components.iconPlaceholder}
            />
          </View>
        </TouchableOpacity>
